...
angular.module('multicollideGame', ['multicollideGame.level', 'multicollideGame.player', 'multicollideGame.canvasRender', 'multicollideGame.config'])
  .directive('multicollideGame', function () {

    return {
      restrict: 'E',
      templateUrl: 'scripts/multicollide/multicollide.html',
      controller: function($scope, level, Player, canvasRender, config, lobby, $rootScope, socketgenapi, STATES){
        // initialization
